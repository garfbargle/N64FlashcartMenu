...
### Gameflix: a console-first game launcher
...
duplicate ROMs and ambiguous save paths stay out of the experience. Covers are
decoded progressively, cached on the SD card, and prepared for the next page
